...
describe Game do
  ...
  it "should score 300 for a game" do #ok
    game.score(12.times.map { 10 }).should be == 300
  end

  it "should score 0 for a gutter game" do #ok
    game.score(12.times.map { 0 }).should be 0
  end

  it "should score 20 for a game of all ones"  do #ok
  ...
  it "should score 10 when a strike is followed by two gutter balls" do #ok
    game.score([10] + 19.times.map { 0 }).should be == 10
  end

  it "should score 20 when a gutter is followed by rolls of 10 and 5 pins" do #ok
    game.score([0,10,5] + 17.times.map { 0 }).should be == 20
  end

   it "should score 150 for rolls of all 5" do #spares
